...
public class Rating {
    ...
    // The statistical mean value of the data (also known as μ).
    private final double mean;

    // The standard deviation (the spread) of the data. This is also known as σ.
     ...
     * Constructs a data.
     *
     * @param mean              The statistical mean value of the data (also known as μ).
     * @param standardDeviation The standard deviation of the data (also known as σ).
     */
     ...
     * Constructs a data.
     *
     * @param mean                                    The statistical mean value of the data (also
     *                                                known as μ).
    ...
    /**
     * @return The variance of the data (standard deviation squared).
     */
    ...
    public static Rating partialUpdate(Rating prior, Rating fullPosterior,
    ...
    public String toString() {
        // As a debug helper, display a localized data:
