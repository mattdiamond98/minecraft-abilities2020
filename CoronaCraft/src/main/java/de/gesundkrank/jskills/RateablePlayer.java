 ...
 */
public class RateablePlayer<T> implements IPlayer, SupportPartialPlay, SupportPartialUpdate {
     ...
     */
    public RateablePlayer(T id, double partialPlayPercentage) {
     ...
     */
    public RateablePlayer(T id, double partialPlayPercentage, double partialUpdatePercentage) {
    ...
    public boolean equals(Object o) {
        ...
        RateablePlayer<?> player = (RateablePlayer<?>) o;
