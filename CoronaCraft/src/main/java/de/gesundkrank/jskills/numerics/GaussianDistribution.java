...
public class GaussianDistribution {
    ...
    public static double logProductNormalization(GaussianDistribution left,
                                                 GaussianDistribution right) {
    ...
    public static GaussianDistribution divide(GaussianDistribution numerator,
    ...
    public static double logRatioNormalization(GaussianDistribution numerator,
                                               GaussianDistribution denominator) {
