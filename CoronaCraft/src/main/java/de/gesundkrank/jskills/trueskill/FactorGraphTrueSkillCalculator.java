...
public class FactorGraphTrueSkillCalculator extends SkillCalculator {
    ...
    public double calculateMatchQuality(GameInfo gameInfo, Collection<ITeam> teams) {
        ...
        SimpleMatrix playerTeamAssignmentsMatrix =
        ...
        SimpleMatrix aTa = playerTeamAssignmentsMatrixTranspose
                .mult(playerTeamAssignmentsMatrix).scale(betaSquared);
        SimpleMatrix aTSA = playerTeamAssignmentsMatrixTranspose.mult(skillsMatrix)
     ...
     * </pre>
     */
    private static SimpleMatrix CreatePlayerTeamAssignmentMatrix(List<ITeam> teamAssignmentsList,
                                                                 int totalPlayers) {
